...
class vit_shrink_conv(VisionTransformer):
    def __init__(self,
                 shrink_idx=8,
                 img_size=224,
                 patch_size=16,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(vit_shrink_conv, self).__init__(
            img_size,
            patch_size,
            in_channels,
            embed_dims,
        ...
        self.shrink = nn.Conv2d(embed_dims, embed_dims, kernel_size=2, stride=2,)
