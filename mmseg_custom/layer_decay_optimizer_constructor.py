...
class LearningRateDecayOptimizerConstructorNew(DefaultOptimizerConstructor):
        ...
        for name, param in module.named_parameters():
            ...
            if 'layer_wise' in decay_type:
                if 'ConvNeXt' in module.backbone.__class__.__name__:
                    ...
                    logger.info(f'set param {name} as id {layer_id}')
                elif 'MAE' in module.backbone.__class__.__name__:
                    layer_id = get_layer_id_for_vit(name, num_layers)
                    logger.info(f'set param {name} as id {layer_id}')
                else:
...
@OPTIMIZER_BUILDERS.register_module()
class LayerDecayOptimizerConstructorNew(LearningRateDecayOptimizerConstructorNew):
    """Different learning rates are set for different layers of backbone.
    ...
    def __init__(self, optimizer_cfg, paramwise_cfg):
        ...
        super(LayerDecayOptimizerConstructorNew,
